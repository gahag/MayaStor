...
let
  sources = {
    "@grpc/proto-loader-0.3.0" = {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@grpc/proto-loader/-/proto-loader-0.3.0.tgz";
    ...
    "@types/lodash-4.14.122" = {
      ...
      version = "4.14.122";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/lodash/-/lodash-4.14.122.tgz";
        sha512 = "9IdED8wU93ty8gP06ninox+42SBSJHp2IAamsSYMUY76mshRTeUsid/gtbl8ovnOwy8im41ib4cxTiIYMXGKew==";
      };
    };
    "@types/long-4.0.0" = {
    ...
    "@types/node-10.12.29" = {
      ...
      version = "10.12.29";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-10.12.29.tgz";
        sha512 = "J/tnbnj8HcsBgCe2apZbdUpQ7hs4d7oZNTYA5bekWdP0sr2NGsOpI/HRdDroEi209tEvTcTtxhD0FfED3DhEcw==";
      };
    };
    "@types/node-10.14.22" = {
      name = "_at_types_slash_node";
    ...
    "@types/node-9.6.44" = {
      ...
      version = "9.6.44";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-9.6.44.tgz";
        sha512 = "hR+jK4kSOX+u5aQ6Zj6az5N4l1AeXH37/sOenbgxJvkO450C5qQL4/1twdufIMLC3o3hNfJNrPfQn0ivMdKfPg==";
      };
    };
    "accepts-1.3.7" = {
      name = "accepts";
    ...
    "grpc-1.18.0" = {
      ...
      version = "1.18.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/grpc/-/grpc-1.18.0.tgz";
        sha512 = "M0K67Zhv2ZzCjrTbQvjWgYFPB929L+qAVnbNgXepbfO5kJxUYc30dP8m8vb+o8QdahLHAeYfIqRoIzZRcCB98Q==";
      };
    };
    "grpc-kit-0.2.0" = {
      name = "grpc-kit";
      packageName = "grpc-kit";
      version = "0.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/grpc-kit/-/grpc-kit-0.2.0.tgz";
        sha512 = "SHUUhBIH2XoFrGff3V+XSCF71ZET2YWAjtRMhZnRW+7s7T+zcI84HWFED4sLPGXMokCY064lgleNgwc6D1cc4Q==";
      };
    };
    "grpc-mock-0.3.1" = {
      name = "grpc-mock";
      packageName = "grpc-mock";
      version = "0.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/grpc-mock/-/grpc-mock-0.3.1.tgz";
        sha512 = "oGIvtE1JrfQfxP66ArbdhhvwqdBS5keslLuTwKTaO241bdEOs6scbLaxvFEP13XXbjZbYEt/necIW55L+gY9uA==";
      };
    };
    "grpc-promise-1.4.0" = {
      name = "grpc-promise";
    ...
    "wtfnode-0.8.0" = {
      ...
      version = "0.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/wtfnode/-/wtfnode-0.8.0.tgz";
        sha512 = "A5jm/0REykxUac1q4Q5kv+hDIiacvqVpwIoXzCQcRL7syeEKucVVOxyLLrt+jIiZoXfla3lnsxUw/cmWXIaGWA==";
      };
    };
    "y18n-3.2.1" = {
      name = "y18n";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."grpc-1.18.0"
      sources."grpc-kit-0.2.0"
      (sources."grpc-mock-0.3.1" // {
        dependencies = [
          sources."@grpc/proto-loader-0.3.0"
          sources."@types/node-9.6.44"
          (sources."protobufjs-6.8.8" // {
            dependencies = [
              sources."@types/node-10.12.29"
            ];
          })
        ];
      })
